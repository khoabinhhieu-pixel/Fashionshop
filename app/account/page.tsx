...
export default async function AccountPage() {
  ...
  return (
    <div className="mx-auto w-full max-w-(--container-page) px-5 py-16 md:px-10 md:py-24">
      ...
      <Reveal delay={0.05} className="mt-10 grid max-w-2xl gap-6 sm:grid-cols-2">
        ...
        <div className="border border-border p-6">
          <p className="tracked-label text-[10px] text-fg-muted">Đơn hàng</p>
          <p className="mt-2 text-xl text-fg">Lịch sử mua hàng</p>
          <Link
            href="/account/orders"
            className="mt-3 inline-block text-xs text-fg underline underline-offset-4"
          >
