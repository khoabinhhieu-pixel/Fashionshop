    ...
    <div className="flex flex-1 flex-col">
      <div className="border-b border-border">
        <nav className="tracked-label mx-auto flex max-w-(--container-page) items-center gap-6 px-5 py-4 text-[11px] md:px-10">
          ...
          <Link href="/admin/orders" className="text-fg hover:text-fg-muted">
            Đơn hàng
          </Link>
          <Link href="/admin/homepage" className="text-fg hover:text-fg-muted">
            Trang chủ
          </Link>
          <Link href="/admin/vouchers" className="text-fg hover:text-fg-muted">
            Voucher
          </Link>
