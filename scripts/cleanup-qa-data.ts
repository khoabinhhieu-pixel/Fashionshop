...
async function main() {
  ...
  // Reconcile the demo account's balance with what its remaining
  // transaction history actually adds up to (deleting QA-order
  // transactions above doesn't retroactively undo their balance effect).
