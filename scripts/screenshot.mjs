...
// Product catalog + gender filters
...
// Cart page + checkout page (each needs its own cart item — every shot() call
// opens a fresh isolated browser context, so localStorage starts empty)
...
// Mobile header check (brand name fit, icons)
