...
import { validateVoucherAction } from "@/lib/actions/vouchers";
...
export default function CheckoutForm({
  ...
  async function handleApplyVoucher() {
    ...
    const result = await validateVoucherAction(voucherInput, subtotal);
            ...
            <AnimatePresence mode="wait" initial={false}>
              ...
              {payment === "qr" ? (
                <motion.div
                  ...
                  className="overflow-hidden"
                >
                  <div className="mt-4 flex flex-col items-center gap-3 border border-border-strong p-6 text-center">
                    <QRCodeSVG
                      value={`FASHIONSHOP|STK:0123456789|SOTIEN:${total}|ND:Thanh toan don hang`}
                      size={180}
                    />
            ...
            <div className="mt-6 border-t border-border pt-4">
              ...
              {appliedVoucher ? (
                <div className="mt-2 flex items-center justify-between text-sm">
                  <span className="text-fg">{appliedVoucher.code} đã áp dụng</span>
                  <button
                    type="button"
                ...
                <div className="mt-2 flex gap-2">
                  <input
                    ...
                    placeholder="Nhập mã"
                    className="w-full border-b border-border-strong bg-transparent py-2 text-sm text-fg placeholder:text-fg-muted focus:border-fg focus:outline-none"
                  />
                  <Button
                    type="button"
                    variant="outline"
            ...
            <div className="mt-4 flex flex-col gap-2 border-t border-border pt-4 text-sm">
              ...
              {discountAmount > 0 ? (
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-fg">−{formatVND(discountAmount)}</span>
                </div>
              ) : null}
